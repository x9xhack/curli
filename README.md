...
Download a [binary package](https://github.com/x9xhack/curli/releases)
...
```sh
docker run --rm -it x9xhack/curli [CURL_OPTIONS...] [METHOD] URL [ITEM [ITEM]]

docker run --rm -it x9xhack/curli version
docker run --rm -it x9xhack/curli -I https://github.com
```
